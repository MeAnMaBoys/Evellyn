                ...
                <div class="col-sm-6 h-100">
                    ...
                    <div class="form-group h-100" style="padding-top: 100px;">
                      ...
                      <div class="form-group h-100">
                        ...
                        echo "<input name='user' type='text' class=\"$class\" placeholder='user@gmail.com ili user198>";
                        
                        if(isset($password_msg))
                        {
                            echo "<small style=\"color:#AD343E; font-size:18px;\" class=\"form-text is-invalid\">$password_msg</small>";
                        }
                        ?>
